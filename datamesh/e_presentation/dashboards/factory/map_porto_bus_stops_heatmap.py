...
def add_heatmap_to_map(df):
    heat_data = [[row["stop_lat"], row["stop_lon"]] for _, row in df.iterrows()]
...
# Add the heatmap of the filtered data points to the map
add_heatmap_to_map(bus_stops_df_unique)
...
def add_porto_main_institutions_datapoints_to_map(m):
    ...
    for data_point in data_points:
        ...
        icon_image = type_to_icon.get(type, "./datamesh/e_presentation/dashboards/factory/html/images/default.png")
...
subfolder = "html"
filename = "map_porto_filtered_markers_using_layers.html"
...
print("Map with filtered markers (using LayerControl) saved to map_porto_filtered_markers_using_layers.html")
